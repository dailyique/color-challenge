...
pad(double left, double right) => EdgeInsets.fromLTRB(left, right, 0.0, 0.0);
  ...
  Widget build(BuildContext context) => StoreConnector<AppState, AppState>(
    ...
    //     onPhoneShake: () => store.dispatch(Action.shake)),
      ...
      builder: (context, state) {
        var w = MediaQuery.of(context).size.height / 16 * 6.5,
        ...
        return Scaffold(
            ...
            body: Center(
              child: SizedBox(
                ...
                width: MediaQuery.of(context).size.height / 16 * 7,
                child: Container(
                    decoration: setBg(state.page < 0 ? 'p0.png' : 'p1.png'),
                    child: state.page >= 0
                        ? Column(
